    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <?php
                if (isset($_GET['type_id']) && isset($_GET['president_id'])) {
                    $type_id = $_GET['type_id'];
                    $president_id = $_GET['president_id'];

                    $sql = "SELECT * FROM persident INNER JOIN type ON persident.type_id = type.type_id WHERE persident_id = $president_id";
                    $result = $pdo->query($sql);
                    $president = $result->fetch();
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row mt-5">
                                <div class="col">
                                    <h2>แก้ไขข้อมูล <?php echo $president['persident_name']; ?></h2>
                                    <h4> <?php echo $president['type_Name']; ?></h4>
                                    <form action="../process/edit_president.php" method="POST">
                                        <!-- เพิ่มฟิลด์สำหรับรับค่า ID ประธานกรรมการ -->
                                        <input type="hidden" name="president_id" value="<?php echo $president_id; ?>">

                                        <div class="mb-3">
                                            <label for="president_name" class="form-label">ชื่อ-นามสกุล:</label>
                                            <input type="text" class="form-control" id="president_name" name="president_name" required value="<?php echo $president['persident_name']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="position" class="form-label">ตำแหน่ง:</label>
                                            <input type="text" class="form-control" id="position" name="position" required value="<?php echo $president['persident_rank']; ?>">
                                        </div>
                                        <!-- เพิ่มฟิลด์สำหรับรับค่า ID ประธานกรรมการ -->
